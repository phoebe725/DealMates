...
const zhHans: Record<string, string> = {
  ...
  "Come share this dining plan with me on PinTable.": "来 PinTable 和我一起拼这场饭局。",
  "Link copied": "链接已复制",
  ...
  "Male only": "仅限男生",
  Organiser: "组织者",
  "Lock in the time": "锁定时间",
  "Lock in the meet-up time": "锁定聚会时间",
  Lock: "锁定",
  "Who actually showed up?": "谁实际到场了？",
  "Tap to toggle who attended. We use this to keep credit scores honest.": "点按切换每个人的出席状态，用于保持信誉分真实可靠。",
  Confirm: "确认",
  Remove: "移除",
  "Remove %@ from the group?": "将 %@ 移出饭局？",
  "New poll": "新投票",
  Question: "问题",
  Options: "选项",
  "Add option": "添加选项",
  Post: "发布",
  "Option %lld": "选项 %lld",
  "Where should we eat?": "我们去哪儿吃？",
  "%lld votes": "%lld 票",
  "by %@": "由 %@ 发起",
  "Report or block": "举报或屏蔽",
  "Report this plan": "举报此饭局",
  "Block this user": "屏蔽此用户",
  "Plan already reported": "已举报此饭局",
  "User already blocked": "已屏蔽此用户",
  "Reported content is reviewed by moderators. Repeated misuse may result in removal from PinTable.": "举报内容将由审核员审查。多次滥用可能导致被移出 PinTable。",
...
const zhHant: Record<string, string> = {
  ...
  "Come share this dining plan with me on PinTable.": "來 PinTable 和我一起拼這場飯局。",
  "Link copied": "連結已複製",
  "Copy this link": "複製此連結",
  ...
  "Male only": "僅限男生",
  Organiser: "組織者",
  "Lock in the time": "鎖定時間",
  "Lock in the meet-up time": "鎖定聚會時間",
  Lock: "鎖定",
  "Who actually showed up?": "誰實際到場了？",
  "Tap to toggle who attended. We use this to keep credit scores honest.": "點按切換每個人的出席狀態，用於保持信譽分真實可靠。",
  Confirm: "確認",
  Remove: "移除",
  "Remove %@ from the group?": "將 %@ 移出飯局？",
  "New poll": "新投票",
  Question: "問題",
  Options: "選項",
  "Add option": "新增選項",
  Post: "發布",
  "Option %lld": "選項 %lld",
  "Where should we eat?": "我們去哪兒吃？",
  "%lld votes": "%lld 票",
  "by %@": "由 %@ 發起",
  "Report or block": "舉報或封鎖",
  "Report this plan": "舉報此飯局",
  "Block this user": "封鎖此使用者",
  "Plan already reported": "已舉報此飯局",
  "User already blocked": "已封鎖此使用者",
  "Reported content is reviewed by moderators. Repeated misuse may result in removal from PinTable.": "舉報內容將由審核員審查。多次濫用可能導致被移出 PinTable。",
