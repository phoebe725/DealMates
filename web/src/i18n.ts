...
const zhHans: Record<string, string> = {
  ...
  Unconfirmed: "待确认",
  "A user reported the price may have changed.": "有用户回报价格可能已变动",
  "Prices can change — flag it if it's wrong.": "价格可能变动 — 有误请回报",
  "Report price": "回报价格",
  "Spotted a different price? Let us know — we'll review it.": "看到不同的价格？告诉我们，我们会核实。",
  "Correct price per person (£)": "正确的每人价格（£）",
  "Anything else? (optional)": "还有其他吗？（可选）",
  "Submit report": "提交回报",
  "Open to any": "不限性别",
  "Female only": "仅限女生",
  "Male only": "仅限男生",
...
const zhHant: Record<string, string> = {
  ...
  Unconfirmed: "待確認",
  "A user reported the price may have changed.": "有用戶回報價格可能已變動",
  "Prices can change — flag it if it's wrong.": "價格可能變動 — 有誤請回報",
  "Report price": "回報價格",
  "Spotted a different price? Let us know — we'll review it.": "看到不同的價格？告訴我們，我們會核實。",
  "Correct price per person (£)": "正確的每人價格（£）",
  "Anything else? (optional)": "還有其他嗎？（可選）",
  "Submit report": "送出回報",
  "Open to any": "不限性別",
  "Female only": "僅限女生",
  "Male only": "僅限男生",
