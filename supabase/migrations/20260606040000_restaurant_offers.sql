...
select * from (values
  ('fa0e7619-0c96-44ec-b61f-02ffe33d8b2b'::uuid, 0, '10% off online orders', '在线订餐 9 折', '線上訂餐 9 折', '10% off when ordering via aisushi.co.uk', '通过 aisushi.co.uk 订餐可享 9 折', '透過 aisushi.co.uk 訂餐可享 9 折', 'other', false, true, NULL, NULL, NULL, 'GBP', NULL, NULL::timestamptz, NULL::timestamptz, true),
